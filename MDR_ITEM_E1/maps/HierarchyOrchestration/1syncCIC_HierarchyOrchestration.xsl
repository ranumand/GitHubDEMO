	...
	<xsl:template name="getDocument">
		...
		<document>
			...
			<informationProviderGLN>
				<xsl:value-of select="/Message/Body/Document/BusinessDocument/CatalogAction/CatalogActionDetails/CatalogItem[MasterCatalog/RevisionID/BaseName='HIERARCHYORCHESTRATION']/ItemData/Attribute[@name='INFORMATION_PROVIDER']/Value"/>
			</informationProviderGLN>
			<targetMarket>US</targetMarket> 


			<gtin>
				<xsl:value-of select="/Message/Body/Document/BusinessDocument/CatalogAction/CatalogActionDetails/CatalogItem[MasterCatalog/RevisionID/BaseName='HIERARCHYORCHESTRATION']/ItemData/Attribute[@name='GTIN']/Value"/>
			</gtin> 
			...
			<!-- don't call the status detail template if CIC code is empty. -->
		...
		<statusDetail>	
			...
			<confirmationStatus>
				...
				<xsl:if test="$Xsl_Param_CICActionNeeded != ''">
					<correctiveInfo>
						<action>
							<xsl:value-of select="$Xsl_Param_CICActionNeeded"/>
						</action> 
